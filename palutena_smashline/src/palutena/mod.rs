...
unsafe fn palutena_game_attackhi3(fighter: &mut L2CAgentBase) {
	...
	for _ in 0..10 {
		if macros::is_excute(fighter) {
			...
			macros::ATTACK(fighter, 1, 0, Hash40::new("top"), 1.0, 100, 100, 40, 0, 3.0, 0.0, 16.0, 10.5, Some(0.0), Some(16.0), Some(-5.0), 0.5, 0.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_POS, true, 0, -1.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_G, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_magic"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_MAGIC, *ATTACK_REGION_MAGIC);
