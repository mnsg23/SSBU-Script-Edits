...
unsafe fn rosetta_sound_batswing4(fighter: &mut L2CAgentBase) {
	...
	if macros::is_excute(fighter) {
		smash_script::macros::PLAY_SE(fighter, Hash40::new("vc_rosetta_attack05"));
	}
}
...
unsafe fn rosetta_sound_win3(fighter: &mut L2CAgentBase) {
	...
	if macros::is_excute(fighter) {
		smash_script::macros::PLAY_SE_NO_3D(fighter, Hash40::new("vc_rosetta_win03"));
	}
	smash::app::sv_animcmd::frame(fighter.lua_state_agent, 20.0);
	if macros::is_excute(fighter) {
		smash_script::macros::PLAY_SE(fighter, Hash40::new("se_rosetta_swing_m_win03"));
	}
	smash::app::sv_animcmd::frame(fighter.lua_state_agent, 107.0);
	if macros::is_excute(fighter) {
		smash_script::macros::PLAY_SE(fighter, Hash40::new("se_tico_return_win03"));
	}
}
